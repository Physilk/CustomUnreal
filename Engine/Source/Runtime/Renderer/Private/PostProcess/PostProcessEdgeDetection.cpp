#include "PostProcessEdgeDetection.h"
...
class FPostProcessEdgeDetectionPS : public FGlobalShader
{
public:
    DECLARE_EXPORTED_SHADER_TYPE(FPostProcessEdgeDetectionPS, Global, /*MYMODULE_API*/);
    ...
    FPostProcessEdgeDetectionPS() {}

    FPostProcessEdgeDetectionPS(const ShaderMetaType::CompiledShaderInitializerType& Initializer)
    ...
    {
        return TEXT("/Engine/Private/PostProcessEdgeDetection.usf");
    }

    static const TCHAR* GetFunctionName()
    {
        return TEXT("MainEdgeDetectionPS");
    }
...
IMPLEMENT_SHADER_TYPE3(FPostProcessEdgeDetectionPS, SF_Pixel)


void FRCPassPostProcessVisualizeEdge::Process(FRenderingCompositePassContext& Context)
{
    ...
    TShaderMapRef<FPostProcessEdgeDetectionPS> PixelShader(Context.GetShaderMap());
...
FPooledRenderTargetDesc FRCPassPostProcessVisualizeEdge::ComputeOutputDesc(EPassOutputId InPassOutputId) const
{
