#include "PostProcessPencilEffect.h"
...
class FPostProcessPencilEffectPS : public FGlobalShader
{
public:
    DECLARE_EXPORTED_SHADER_TYPE(FPostProcessPencilEffectPS, Global, /*MYMODULE_API*/);
    ...
    FPostProcessPencilEffectPS() {}

    FPostProcessPencilEffectPS(const ShaderMetaType::CompiledShaderInitializerType& Initializer)
    ...
    {
        return TEXT("/Engine/Private/PostProcessPencilDrawing.usf");
    }

    static const TCHAR* GetFunctionName()
    {
        return TEXT("MainPencilPS");
    }
...
IMPLEMENT_SHADER_TYPE3(FPostProcessPencilEffectPS, SF_Pixel)


void FRCPassPostProcessVisualizePencilEffect::Process(FRenderingCompositePassContext& Context)
{
    ...
    TShaderMapRef<FPostProcessPencilEffectPS> PixelShader(Context.GetShaderMap());
...
FPooledRenderTargetDesc FRCPassPostProcessVisualizePencilEffect::ComputeOutputDesc(EPassOutputId InPassOutputId) const
{
